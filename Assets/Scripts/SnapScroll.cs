...
public class SnapScroll : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {

	public static SnapScroll instance;
	...
	// event for page changed
	public static UnityAction<int> OnCurrentPageChanged;
	...
	private void SetPage(int aPageIndex) {
		...
		if(aPageIndex != _currentPage)
            OnCurrentPageChanged(aPageIndex);
